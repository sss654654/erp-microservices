...
##  Step 3: Helm Chart에서 Employee Service 제거 (10분)

### 3-1. values-dev.yaml 수정

```bash
cd /mnt/c/Users/Lethe/Desktop/취업준비/erp-project/helm-chart

# values-dev.yaml에서 employee 섹션 비활성화
